...
export default function Home() {
    return (
        <div className="flex flex-col gap-6 justify-center items-center mx-auto max-w-3xl pb-20 w-full h-full">
            ...
            <AccordionItem value="item-1" className="bg-[#ffc299] rounded-lg px-4 shadow-md border-none">
                <AccordionTrigger className="text-4xl font-bebas">Customer Satisfaction Guarantee</AccordionTrigger>
                <AccordionContent className="text-lg">
                Made you look.
                </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2" className="bg-[#ffc299] rounded-lg px-4 shadow-md border-none">
                <AccordionTrigger className="text-4xl font-bebas">Return Policy</AccordionTrigger>
                <AccordionContent className="text-lg">
                Made you look.
                </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3" className="bg-[#ffc299] rounded-lg px-4 shadow-md border-none">
